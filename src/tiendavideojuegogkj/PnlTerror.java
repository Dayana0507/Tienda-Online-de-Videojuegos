 ...
 * @author compu
 */
public class PnlTerror extends javax.swing.JPanel {

    /**
     * Creates new form PnlTerror
     */
    public PnlTerror() {
        initComponents();
    }
   ...
   // GUIProyecto.listaTerror.add(new Terror(lblNombre.getText(),(String)cmbTipoDispositivo.getSelectedItem(),Double.parseDouble(lblPrecio.getText())));
